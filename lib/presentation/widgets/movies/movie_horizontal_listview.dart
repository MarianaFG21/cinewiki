...
import 'package:cinewiki/config/helpers/human_format.dart';
          ...
          SizedBox(
            ...
            child: Row(
              children: [
                ...
                // Text(HumanFormats.number(movie.voteAverage), style: titleStyle.bodyMedium?.copyWith(color: Colors.yellow.shade800)),
                const Spacer(),
